...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
{
    ...
    protected String[] doInBackground(String... params) {
        ...
        try
        {
            //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&cnt=7&mode=json&units=metric");
            String base = "http://api.openweathermap.org/data/2.5/forecast/daily";
            Uri.Builder builder = new Uri.Builder();
            //builder.appendEncodedPath(base);
            builder.encodedPath(base);
    ...
    protected void onPostExecute(String[] strings) {
        if (strings != null){
            ...
            ForecastFragment.mForecastAdapter.addAll(strings);
